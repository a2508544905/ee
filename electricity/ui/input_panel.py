...
class InputPanel(ttk.LabelFrame):
    ...
    def __init__(self, master, regions, on_calculate, default_region=None, **kwargs):
        ...
        # 用户名（纯标签，可留空）
        ttk.Label(self, text="用户名：").grid(row=0, column=0, sticky="w")
        self.username_var = tk.StringVar()
        ttk.Entry(self, textvariable=self.username_var, width=12).grid(row=0, column=1, padx=6)
